...
public class DashboardFragment extends BaseFragment {
    ...
    private View.OnClickListener addButtonAccountListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Navigate to Account
                mListener.startFeatureCreate(AppConstants.FEATURE_TYPE_ACCOUNT);
            }
        };
    }
    ...
    private View.OnClickListener addButtonBillsListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Navigate to Account
                mListener.startFeatureCreate(AppConstants.FEATURE_TYPE_BILLS);
            }
        };
    }
    ...
    private View.OnClickListener addButtonCheckListListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Navigate to Account
                mListener.startFeatureCreate(AppConstants.FEATURE_TYPE_CHECK_LIST);
                ;
            }
        };
    }
    ...
    public interface DashBoardFragmentListener {
        void startFeatureCreate(int feature);
