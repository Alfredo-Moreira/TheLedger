 ...
 */
public class CheckListDeleteListRequest extends BaseRequest<BaseResponse>{

    public CheckListDeleteListRequest(String url,Response.Listener<BaseResponse> listener, Response.ErrorListener errorListener) {
