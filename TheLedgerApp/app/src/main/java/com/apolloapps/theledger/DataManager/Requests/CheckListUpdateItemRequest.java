 ...
 */
public class CheckListUpdateItemRequest extends BaseRequest<BaseResponse> {

    public CheckListUpdateItemRequest(String url, JSONObject object, Response.Listener<BaseResponse> listener, Response.ErrorListener errorListener) {
