...
/**
 * Created by AMoreira on 7/29/16.
 */
public class BillUpdateRequest extends BaseRequest<BaseResponse> {

    public BillUpdateRequest(String url, JSONObject object,Response.Listener<BaseResponse> listener, Response.ErrorListener errorListener) {
